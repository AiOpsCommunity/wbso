...
Vastleggen wat de WBSO-aanvraag van dit project inhoudt: de periode, het aantal
aangevraagde uren, het tarief, de forfaitkeuze, de S&O-projecten waaraan boekingen
worden opgehangen, en de afbakening van werk dat niet kwalificeert.

De configuratie wordt opgezet met `/wbso:init`, dat vier vragen stelt en de rest
voorstelt of vermeldt. De afbakening is functioneel en niet documentair: `/wbso:dag`
waarschuwt ermee, en een lege afbakening wordt geweigerd.
